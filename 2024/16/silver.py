...
for node in it:
    ...
    best_score = best_score_so_far[node.current_pos][node.current_dir.value]
...
print()
best_path = min(best_score_so_far[end_pos], key=lambda s: s.score)
print(best_path.summary())

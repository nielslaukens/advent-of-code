"""
Not optimized enough. See part 1
"""
...
scanner_positions = {0: ((0, 0, 0), numpy.array([[1, 0, 0], [0, 1, 0], [0, 0, 1]]))}
...
while len(sensors_to_position):
    for sensor_to_position in sensors_to_position:
        ...
        scanner_positions[sensor_to_position] = t, r
...
max_manhattan_distance_pair = None
for a in scanner_positions.keys():
    for b in scanner_positions.keys():
        a_pos = scanner_positions[a][0]
        b_pos = scanner_positions[b][0]
        manhattan_distance = abs(a_pos[0] - b_pos[0]) + abs(a_pos[1] - b_pos[1]) + abs(a_pos[2] - b_pos[2])
        if manhattan_distance > max_manhattan_distance:
            max_manhattan_distance = manhattan_distance
            max_manhattan_distance_pair = (a, b)

print(f"Max Manhattan distance: {max_manhattan_distance}")
print(f"Between {max_manhattan_distance_pair[0]} ({scanner_positions[max_manhattan_distance_pair[0]][0]}) "
      f"and {max_manhattan_distance_pair[1]} ({scanner_positions[max_manhattan_distance_pair[1]][0]})")
